...
export async function exportStockPdf(
  ...
  // ฟังก์ชันวาดแถบหัวกระดาษสีน้ำเงิน (ปรับขนาดตัวอักษรและตำแหน่งให้สมดุล)
  function drawHeader() {
  ...
  // จัดกลุ่มสินค้าตามหมวดหมู่ (Category)
  ...
  autoTable(doc, {
    ...
    // 🔥 แก้ไขจุดนี้: ขยับขอบบนของหน้าถัดๆ ไป (top: 24) ให้ต่ำลงมาหลบแถบสีน้ำเงินอย่างสมบูรณ์แบบ
    margin: { left: 8, right: 8, top: 24, bottom: 24 },
    // 🔥 ถอด rowPageBreak: "avoid" ออก เพื่อให้หมวดหมู่แบบ colSpan ไม่พาตารางเอ๋อ
    showHead: "everyPage",
    didParseCell: (data) => {
